...
<Accidents/10000 people chart>

This chart reveals a different picture compared to the prior chart. It is apparent that Manhattan has a higher number of accidents per 1000 residents compared to Brooklyn - making it more dangerous.
...
We also wanted to see which ZIP codes had the highest fatalities. 

<fatalities chart>

The ZIP codes which have the highest accidents and fatalities are the following:

<zip code cleaveland charts>
...
### On Design Choices:
The above chart is a polar coordinate representation of the bar chart we saw above. The Cartesian bar chart is significantly easier to read and make inferences from. The differneces in values are linear and intuitive. However it fails to capture the cyclical nature of months (Decmber looping over to January) which is better captured by the Polar bar chart.
